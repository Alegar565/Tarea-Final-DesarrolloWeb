          ...
          {currentItems &&
            currentItems.map((product) => (
              <div className={defaultTdWrapperStyle} key={product.id}>
                ...
                <div className={defaultTdStyle}>
                  <div className={defaultTdContentTitleStyle}>Clasificación</div>
                  <div className={defaultTdContent}>
                    <span className="whitespace-nowrap text-ellipsis overflow-hidden">
                ...
                <div className={defaultTdStyle}>
                  <div className={defaultTdContentTitleStyle}>Fecha</div>
                  <div className={defaultTdContent}>
                    <span className="whitespace-nowrap text-ellipsis overflow-hidden">
                      {product.fecha}
                    </span>
                ...
                <div className={defaultTdStyle}>
                  <div className={defaultTdContentTitleStyle}>Empleado</div>
                  <div className={defaultTdContent}>
                    <span className="whitespace-nowrap text-ellipsis overflow-hidden">
                      {product.empleados}
                    </span>
                ...
                <div className={defaultTdStyle}>
                  <div className={defaultTdContentTitleStyle}>Proveedor</div>
                  <div className={defaultTdContent}>
                    <span className="whitespace-nowrap text-ellipsis overflow-hidden">
                      {product.proveedor}
                    </span>
                ...
                <div className={defaultTdStyle}>
                  <div className={defaultTdContentTitleStyle}>Cantidad</div>
                  <div className={defaultTdContent}>
                    <span className="whitespace-nowrap text-ellipsis overflow-hidden">
                      {product.cantidad}
                    </span>
                ...
                <div className={defaultTdStyle}>
                  <div className={defaultTdContentTitleStyle}>N. Lote</div>
                  <div className={defaultTdContent}>
                    <span className="whitespace-nowrap text-ellipsis overflow-hidden">
                      {product.lote}
                    </span>
